...
python main.py --gpu 6 --seed 1 --source_path /export/home/karoth/Datasets --savename result_run_cub200   --dataset cub200 --shared_num_classes 30  --cluster_update_freq 3 --adv_weights 2500 --task_p 1 0.8 --tau 52 --n_epochs 110 --random_cluster_pick_p 0.2
python main.py --gpu 7 --seed 2 --source_path /export/home/karoth/Datasets --savename result_run_cars196  --dataset cars196 --shared_num_classes 200  --cluster_update_freq 3  --adv_weights 500 --task_p 1 0.8 --tau 65 --n_epochs 110 --random_cluster_pick_p 0.2



python main.py --gpu 9 --seed 1 --savename result_run_inshop --source_path /export/home/karoth/Datasets --dataset in-shop --shared_num_classes 150 --cluster_update_freq 3 --random_cluster_pick_p 0.2 --adv_weights 250 --task_p 1 0.8 --tau 45 --n_epochs 70
